    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
          ...
          <div className="flex-1 ">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/DanielEgiidio.png"
                alt=""
              />
              <div className="leading-relaxed">
                ...
                <span className="text-gray-200 text-sm block">
                  Software Engineer | Front-end | ReactJS | Javascript |
                  Typescript
                </span>
              </div>
            </div>
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a
            href=""
            className="bg-gray-700 rounded overflow-hidden flex flex-items-stretch gap-6 hover:bg-gray-600 transition-colors"
          >
